ได้เลยครับ ผมรวมโค้ดที่แก้ไขจุดผิดพลาดทั้งหมดให้เรียบร้อยแล้ว (ปิดกล่องโค้ด Python ให้แล้ว และลบช่องว่างหน้าบรรทัดเพื่อไม่ให้กลายเป็นกล่องสีเทา)

คุณสามารถ **ลบโค้ดของเก่าในไฟล์ `README.md` ออกให้หมด** แล้วคัดลอกโค้ดด้านล่างนี้ไปวางแทนที่ได้เลยครับ รับรองว่าแสดงผลถูกต้องแน่นอนครับ:
...
Marie Vitthaya School, Nakhon Ratchasima, Thailand
